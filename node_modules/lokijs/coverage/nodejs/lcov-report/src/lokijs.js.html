...
4091
4092
4093</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof transform === 'object' &amp;&amp; Array.isArray(transform)) {
...
<span class="cstat-no" title="statement not covered" >      delete transforms[name];</span>
    };
&nbsp;
...
&nbsp;
      // if transform is name, then do lookup first
      if (typeof transform === 'string') {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.transforms.hasOwnProperty(transform)) {
